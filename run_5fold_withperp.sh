...
for fold in 1 2 3 4 5; do
  checkpoint_dir="/data/storage2/projects/early/BDHPD/run_withpersp/${meta_root}/fold_${fold}"
  ...
  CUDA_VISIBLE_DEVICES=${cuda_device} python train.py --config ${config_file} \
    ...
    --Neurovoz_and_PC_GITA.train_metadata_path="${meta_root}/fold_${fold}/sub_splits/train_early_persp.tsv" \
